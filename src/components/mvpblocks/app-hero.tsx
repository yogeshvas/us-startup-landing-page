...
export default function AppHero() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats((prev) => {
        const newTeams = prev.teams >= 1000 ? 1000 : prev.teams + 25;
        const newProjects = prev.projects >= 5000 ? 5000 : prev.projects + 125;
        const newImprovements =
          prev.improvements >= 80 ? 80 : prev.improvements + 2;
  ...
  const handleCalendlyClick = () => {
    if (window.Calendly) {
      window.Calendly.initPopupWidget({
        url: "https://calendly.com/writetokhair/30min",
      });
    }
  };
    ...
    <section className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-black py-16 text-white sm:px-6 lg:px-8 lg:py-2">
      ...
      <div className="fadein-blur relative z-0 mx-auto mb-10 h-[300px] w-[300px] lg:absolute lg:top-1/2 lg:right-1/2 lg:mx-0 lg:mb-0 lg:h-[500px] lg:w-[500px] lg:translate-x-1/2 lg:-translate-y-2/3">
        <img
          ...
          alt="Streamline Platform 3D Visualization"
        ...
        <motion.div className="flex w-full flex-col items-center justify-between lg:flex-row lg:items-start">
          <div className="w-full lg:w-auto">
            ...
            >
              ...
              Introducing Streamline Platform
            </motion.div>
            ...
            >
              Streamline Your Workflow, <br className="hidden sm:inline" />
              <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                Achieve Unified Success
              </span>
            </motion.h1>
          ...
          <div className="mt-6 flex flex-col items-center lg:mt-0 lg:items-end">
            ...
            >
              Streamline operations with automated workflows, foster a scalable
              and agile team culture, and accelerate delivery with shift-left
              integration for unmatched efficiency and quality.
            </motion.p>
            <motion.div
              variants={itemVariants}
